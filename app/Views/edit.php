        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="tensach"
                       value="<?= $data['tensach'] ?? $book->tensach ?? "" ?>"/>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="soluong"
                       value="<?= $data['soluong'] ?? $book->soluong ?? "" ?>"/>
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" name="email"
                       value="<?= $data['email'] ?? $book->email ?? "" ?>"/>
                <span class="text-danger"><?= $errors['email'] ?? "" ?></span>
            </div>
            <div class="mb-3">
                <label for="">Ảnh cũ</label>
                <img src="<?= ROOT_PATH ?>images/<?= $book->anh ?>" alt="" width="100">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" name="maloai">
                    ...
                    <?php foreach ($categories as $ls) : ?>
                        <option <?= $ls->id === $book->maloai ? "selected" : "" ?>
                                value="<?= $ls->id ?>"><?= $ls->tenloai ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="mota" id="" cols="30"
                          rows="10"><?= $data['mota'] ?? $book->mota ?? "" ?></textarea>
